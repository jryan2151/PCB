...
/* Pull in FatFs basic types: BYTE, WORD, DWORD, UINT, LBA_t, etc. */
#include "ff.h"
...
#define CTRL_TRIM           4   /* Inform device that data on the block is no longer used (needed at FF_USE_TRIM == 1) */
